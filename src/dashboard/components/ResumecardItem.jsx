...
GlobalApi.DeleteResumeById(resume.documentId).then(resp=>{
  ...
  return (
    ...
    <Link to={`/dashboard/resume/${resume.documentId}"/edit`}>
        <div className='p-14  border-t-red-500 bg-gradient-to-b from-pink-100  via-purple-200 to-blue-200
         flex items-center 
        justify-center h-[300px] 
     rounded-lg border-t-4 hover:scale-105 transition-all
         hover:shadow-md shadow-purple-600'
         style={{
    ...
    <div className='border p-3 flex justify-between  text-white rounded-b-lg shadow-lg'
       ...
       {/* ye humne shadcn ke dropdown menu se download kiye hai */}
       <DropdownMenu>
           <DropdownMenuTrigger>
  ...
  <AlertDialogContent className="bg-slate-200">
    <AlertDialogHeader>
      <AlertDialogTitle className="text-purple-700">Are you absolutely sure?</AlertDialogTitle>
      <AlertDialogDescription >
    ...
    <AlertDialogFooter>
      ...
      <AlertDialogAction className="bg-purple-600" onClick={onDelete}
       disabled={loading} >
